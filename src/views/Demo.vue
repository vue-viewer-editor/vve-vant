<template>
  <div>
    <van-button size="large" block round loading loading-text="3333" loading-type="spinner">按钮33333</van-button>
    <van-button size="normal" class="__p_6y_u_3">按钮</van-button>
    <div>
